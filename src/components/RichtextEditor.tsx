...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ value, onChange }) => {
  ...
  // This effect updates the editor content when the prop value changes.
  useEffect(() => {
  ...
  return (
    <div className="py-2 bg-white">
      <div className="flex justify-between mb-4 items-center">
        <div className="flex gap-2">
          ...
          <button
            ...
            title="Bullet List"
          >
            <img src="/icons/bullet_list.svg" alt="bullet list" className="w-4 h-4" />
          </button>
          <button
            ...
            title="Ordered List"
          >
            <img src="/icons/ordered_list.svg" alt="ordered list" className="w-4 h-4" />
          </button>
          <button
            ...
            title="Align Left"
          >
            <img src="/icons/text_left.svg" alt="align left" className="w-4 h-4" />
          </button>
          <button
            ...
            title="Align Center"
          >
            <img src="/icons/text_center.svg" alt="align center" className="w-4 h-4" />
          </button>
          <button
            ...
            title="Align Right"
          >
            <img src="/icons/text_right.svg" alt="align right" className="w-4 h-4" />
          </button>
        </div>
        <button
      ...
      {isHtmlMode ? (
        ...
        <EditorContent
          editor={editor}
          className="min-h-[300px] mt-1 p-2 text-gray-900 w-full border border-gray-400"
        />
      )}
    </div>
  );
